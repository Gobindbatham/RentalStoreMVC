...
namespace RentalStore.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(RentalStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Name,Contact,Address")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,Contact,Address")] Publisher publisher)
        {
            if (id != publisher.id)
            {
                return NotFound();
